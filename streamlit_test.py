...
st.markdown('<h2 style="font-size:20px; font-family:\'Times New Roman\', serif; color:#333333;">1. Country $\mathrm{CO}_2$ Emissions per Year Over Time</h2>', unsafe_allow_html=True)
